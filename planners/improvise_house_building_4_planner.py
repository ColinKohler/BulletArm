...
class ImproviseHouseBuilding4Planner(BlockStructureBasePlanner):
  def __init__(self, env, config):
    super(ImproviseHouseBuilding4Planner, self).__init__(env, config)
  ...
  def getIncompleteFirstLayerObjs(self):
    ...
    for (obj1, obj2) in rand_obj_1_combs:
      pos1 = obj1.getPosition()
      pos2 = obj2.getPosition()
      if self.getDistance(obj1, obj2) < 3.2 * self.getMaxBlockSize() and self.isObjOnTop(obj1) and self.isObjOnTop(
          obj2):
