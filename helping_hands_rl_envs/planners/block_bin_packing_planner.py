...
class BlockBinPackingPlanner(BlockStructureBasePlanner):
  ...
  def getPlacingAction(self):
    ...
    avg_heightmap = ndimage.uniform_filter(self.env.heightmap, 0.07//self.env.heightmap_resolution, mode='nearest')
    ...
    min_pixel = min_pixel // avg_heightmap_box.shape[0], min_pixel % avg_heightmap_box.shape[0]
