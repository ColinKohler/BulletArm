...
def createTiltHouseBuilding2DeconstructEnv(simulator_base_env, config):
  class TiltHouseBuilding2DeconstructEnv(PyBulletTiltDeconstructEnv):
    ''''''
    ...
    def reset(self):
      ''''''
      super(TiltHouseBuilding2DeconstructEnv, self).reset()
      self.generateH2()
  ...
  def _thunk():
    return TiltHouseBuilding2DeconstructEnv(config)
