...
def createTiltImproviseHouseBuilding3DeconstructEnv(simulator_base_env, config):
  class TiltImproviseHouseBuilding3DeconstructEnv(PyBulletTiltDeconstructEnv):
    ''''''
    ...
    def reset(self):
      ''''''
      super(TiltImproviseHouseBuilding3DeconstructEnv, self).reset()
  ...
  def _thunk():
    return TiltImproviseHouseBuilding3DeconstructEnv(config)
