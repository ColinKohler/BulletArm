...
def createTiltHouseBuilding1Env(simulator_base_env, config):
  class TiltHouseBuilding1Env(PyBulletTiltEnv):
    ...
    def reset(self):
      ...
      self.generateTiltAndObj(obj_dict)
  ...
  def _thunk():
    return TiltHouseBuilding1Env(config)
