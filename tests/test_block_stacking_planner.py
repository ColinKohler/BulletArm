...
workspace = np.array([[0.40, 0.60], [-0.10, 0.10], [0, 1]])
env_config = {'workspace': workspace, 'max_steps': 10, 'obs_size': 96, 'action_sequence': 'pxy',
              'num_objects': 3, 'render': False, 'fast_mode': True, 'simulate_grasps': True, 'robot': 'kuka'}
planner_config = {'pick_noise': 0.0, 'place_noise': 0.0, 'rand_pick_prob': 0.0, 'rand_place_prob': 0.0}
envs = env_factory.createEnvs(1, 'data', 'pybullet', 'block_stacking', env_config, planner_config=planner_config)
heightmap_resolution = 0.2 / 96.
