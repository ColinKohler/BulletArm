...
class TestBulletCloseLoopBlockReaching(unittest.TestCase):
  env_config = {}
  ...
  def testPlanner2(self):
    ...
    num_processes = 1
    env = env_factory.createEnvs(num_processes,  'close_loop_block_reaching', self.env_config, self.planner_config)
    total = 0
    s = 0
    step_times = []
    env.reset()
